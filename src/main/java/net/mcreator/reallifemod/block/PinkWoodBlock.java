...
public class PinkWoodBlock extends RealLifeModModElements.ModElement {
	@ObjectHolder("real_life_mod:pink_wood")
	public static final Block block = null;
	public PinkWoodBlock(RealLifeModModElements instance) {
		super(instance, 2);
	}
